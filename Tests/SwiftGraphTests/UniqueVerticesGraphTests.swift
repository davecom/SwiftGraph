//
//  UniqueVerticesGraphTests.swift
//  SwiftGraph
//
...
class UniqueVerticesGraphTests: XCTestCase {
    ...
    func testUniqueVertexAfterInit() {
        let g = UniqueVerticesGraph<String>(vertices:["Atlanta", "Atlanta"])
        XCTAssertEqual(g.vertices, ["Atlanta"], "Expected one vertex")
    }

    func testUniqueVertexAfterAddition() {
        let g = UniqueVerticesGraph<String>()
